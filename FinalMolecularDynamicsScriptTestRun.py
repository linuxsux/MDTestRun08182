...
simulation.reporters.append(StateDataReporter(stdout, 10, step=True, potentialEnergy=True, kineticEnergy=True, temperature=True, volume=True, density=True))

# Minimize
# Run for 4 ps. May be adjusted
print('Minimizing...')
...
simulation.reporters.append(XTCReporter('Cterm0818.xtc', 10))
simulation.reporters.append(StateDataReporter('Cterm0818.csv', 10, time=True, temperature=True, kineticEnergy=True, potentialEnergy=True))
simulation.reporters.append(PDBReporter('Cterm0818.pdb', 50))
simulation.step(500)